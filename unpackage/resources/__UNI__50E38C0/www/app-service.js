...
var fE=_mz(z,'picker-view',['bindchange',4,'data-event-opts',1,'indicatorStyle',2,'value',3],[],e,s,gg)
var cF=_v()
_(fE,cF)
...
__wxAppCode__['app.json']={"pages":["pages/index/index","pages/setting/setting","pages/cityList/cityList"],"subPackages":[],"window":{"navigationBarTextStyle":"black","navigationBarTitleText":"天气预报","navigationBarBackgroundColor":"#F8F8F8","backgroundColor":"#F8F8F8"},"tabBar":{"color":"#7A7E83","selectedColor":"#007AFF","borderStyle":"black","backgroundColor":"#F8F8F8","list":[{"pagePath":"pages/cityList/cityList","text":"添加城市"},{"pagePath":"pages/index/index","text":"当前城市"},{"pagePath":"pages/setting/setting","text":"设置"}]},"splashscreen":{"alwaysShowBeforeRender":true,"autoclose":false},"appname":"weather-uni-app","compilerVersion":"1.9.4","usingComponents":{}};
__wxAppCode__['app.wxml']=$gwx('./app.wxml');

__wxAppCode__['pages/cityList/cityList.json']={"navigationBarTitleText":"选择城市","usingComponents":{}};
__wxAppCode__['pages/cityList/cityList.wxml']=$gwx('./pages/cityList/cityList.wxml');

__wxAppCode__['pages/index/index.json']={"navigationBarTitleText":"天气预报","usingComponents":{}};
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["common/main"],{"0b2e":function(n,o,e){},9570:function(n,o,e){"use strict";Object.defineProperty(o,"__esModule",{value:!0}),o.default=void 0;var t={onLaunch:function(){console.log("App Launch"," at App.vue:4")},onShow:function(){console.log("App Show"," at App.vue:7")},onHide:function(){console.log("App Hide"," at App.vue:10")}};o.default=t},a232:function(n,o,e){"use strict";e.r(o);var t=e("ab55");for(var u in t)"default"!==u&&function(n){e.d(o,n,function(){return t[n]})}(u);e("e517");var a,c,l=e("2877"),i=Object(l["a"])(t["default"],a,c,!1,null,null,null);o["default"]=i.exports},ab55:function(n,o,e){"use strict";e.r(o);var t=e("9570"),u=e.n(t);for(var a in t)"default"!==a&&function(n){e.d(o,n,function(){return t[n]})}(a);o["default"]=u.a},e517:function(n,o,e){"use strict";var t=e("0b2e"),u=e.n(t);u.a}},[["6bfa","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/setting/setting"],{"2bae":function(t,i,e){},"356f":function(t,i,e){"use strict";e.r(i);var s=e("47a4"),n=e("ed3d");for(var a in n)"default"!==a&&function(t){e.d(i,t,function(){return n[t]})}(a);e("6768");var c=e("2877"),o=Object(c["a"])(n["default"],s["a"],s["b"],!1,null,null,null);i["default"]=o.exports},"47a4":function(t,i,e){"use strict";var s=function(){var t=this,i=t.$createElement;t._self._c},n=[];e.d(i,"a",function(){return s}),e.d(i,"b",function(){return n})},6768:function(t,i,e){"use strict";var s=e("2bae"),n=e.n(s);n.a},b82e:function(t,i,e){"use strict";(function(t){Object.defineProperty(i,"__esModule",{value:!0}),i.default=void 0;var e={data:function(){return{storage_cityList:[]}},onLoad:function(){try{var i=t.getStorageSync("weather_storage_cityList");i&&i.length&&(this.storage_cityList=i)}catch(e){console.log(e," at pages\\setting\\setting.vue:38")}},methods:{formSubmit:function(){try{t.setStorageSync("weather_storage_cityList",this.storage_cityList)}catch(i){console.log(i," at pages\\setting\\setting.vue:46")}},toUpper:function(t,i){if(i>0){var e=this.storage_cityList[i-1];this.storage_cityList.splice(i,1),this.storage_cityList.splice(i-1,1),this.storage_cityList.splice(i-1,0,t),this.storage_cityList.splice(i,0,e)}},toDown:function(t,i){if(i<this.storage_cityList.length-1){var e=this.storage_cityList[i+1];this.storage_cityList.splice(i+1,1),this.storage_cityList.splice(i,1),this.storage_cityList.splice(i,0,e),this.storage_cityList.splice(i+1,0,t)}}}};i.default=e}).call(this,e("6e42")["default"])},ed3d:function(t,i,e){"use strict";e.r(i);var s=e("b82e"),n=e.n(s);for(var a in s)"default"!==a&&function(t){e.d(i,t,function(){return s[t]})}(a);i["default"]=n.a}},[["921b","common/runtime","common/vendor"]]]);
});
require('pages/setting/setting.js');
__wxRoute = 'pages/cityList/cityList';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/cityList/cityList.js';

define('pages/cityList/cityList.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/cityList/cityList"],{"07da":function(t,i,s){"use strict";var e=function(){var t=this,i=t.$createElement;t._self._c},a=[];s.d(i,"a",function(){return e}),s.d(i,"b",function(){return a})},"5fb8":function(t,i,s){"use strict";s.r(i);var e=s("c6c0"),a=s.n(e);for(var c in e)"default"!==c&&function(t){s.d(i,t,function(){return e[t]})}(c);i["default"]=a.a},c6c0:function(t,i,s){"use strict";(function(t){Object.defineProperty(i,"__esModule",{value:!0}),i.default=void 0;var s={data:function(){return{cityList:[],loading:!1,value:[0,0,0],storage_cityList:[],indicatorStyle:"height: ".concat(Math.round(t.getSystemInfoSync().screenWidth/7.5),"px;")}},computed:{selectResult:function(){var t="";return this.cityList.length&&(t+=this.cityList[this.value[0]].name+"-",this.cityList[this.value[0]].districts.length&&(t+=this.cityList[this.value[0]].districts[this.value[1]].name+"-",this.cityList[this.value[0]].districts[this.value[1]].districts.length&&(t+=this.cityList[this.value[0]].districts[this.value[1]].districts[this.value[2]].name))),t},selectAdcode:function(){var t="";return this.cityList[this.value[0]].districts.length?this.cityList[this.value[0]].districts[this.value[1]].districts.length&&(t=this.cityList[this.value[0]].districts[this.value[1]].districts[this.value[2]].adcode):t=this.cityList[this.value[0]].adcode,t},selectCityInfo:function(){var t="";return t=this.cityList[this.value[0]].districts.length?this.cityList[this.value[0]].districts[this.value[1]].districts.length?this.cityList[this.value[0]].districts[this.value[1]].districts[this.value[2]]:this.cityList[this.value[0]].districts[this.value[1]]:this.cityList[this.value[0]],t}},onLoad:function(){this.getCityList();try{var i=t.getStorageSync("weather_storage_cityList");i&&i.length&&(this.storage_cityList=i)}catch(s){console.log(s," at pages\\cityList\\cityList.vue:82")}},methods:{getCityList:function(){var i=this;this.loading=!0,t.showLoading({title:"获取城市数据中..."}),t.request({url:"https://restapi.amap.com/v3/config/district",method:"GET",data:{key:"1155d2464abdf5c3a50d534a5591f293",keywords:"中国",subdistrict:3},success:function(s){1==s.data.status?i.cityList=s.data.districts[0].districts:s.data.info&&t.showModal({content:s.data.info,showCancel:!1})},fail:function(i){console.log("request fail",i," at pages\\cityList\\cityList.vue:112"),t.showModal({content:"获取城市数据失败，请稍后重试",showCancel:!1})},complete:function(){i.loading=!1,t.hideLoading()}})},bindChange:function(t){var i=t.detail.value;i[0]===this.value[0]?i[1]===this.value[1]?this.value=i:this.value=[i[0],i[1],0]:this.value=[i[0],0,0],console.log(this.value," at pages\\cityList\\cityList.vue:135")},addCity:function(){for(var i=this.selectAdcode,s=0,e=this.storage_cityList.length;s<e;s++)if(this.storage_cityList[s].adcode===i){this.storage_cityList.splice(s,1);break}this.storage_cityList.push(this.selectCityInfo);try{t.setStorageSync("weather_storage_cityList",this.storage_cityList)}catch(a){console.log(a," at pages\\cityList\\cityList.vue:149")}}}};i.default=s}).call(this,s("6e42")["default"])},d3ec:function(t,i,s){"use strict";var e=s("ea9d"),a=s.n(e);a.a},dd7b:function(t,i,s){"use strict";s.r(i);var e=s("07da"),a=s("5fb8");for(var c in a)"default"!==c&&function(t){s.d(i,t,function(){return a[t]})}(c);s("d3ec");var n=s("2877"),o=Object(n["a"])(a["default"],e["a"],e["b"],!1,null,null,null);i["default"]=o.exports},ea9d:function(t,i,s){}},[["8997","common/runtime","common/vendor"]]]);
});
require('pages/cityList/cityList.js');
;(function(global) {
